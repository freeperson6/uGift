var debug = require('debug')('UserManager.js');
...
*/
function UserManager(url){  //mongodb://localhost/
...
*/
UserManager.prototype.login = function(profile, callback){
...
*/
UserManager.prototype.loginGoogle = function(profile, callback){
...
*/
UserManager.prototype.getUserList = function(callback){
...
*/
UserManager.prototype.getUserPic = function(id,callback){
...
*/
UserManager.prototype.createUser = function(profile, callback){
...
*/
UserManager.prototype.createUserGoogle = function(profile, callback){
...
UserManager.prototype.deleteUser = function(user, profile, callback){
...
UserManager.prototype.checkAccessRight = function(user, profile, callback){
...
UserManager.prototype.updateProfile = function(user, profile, callback){
...
UserManager.prototype.updateRating =  function(rating, receiver, callback){
...
UserManager.prototype.removeRating =  function(rating, receiver, callback){
	var conditions = { _id: receiver }, options = {}, update ={};
...
UserManager.prototype.changePassword = function(profile, callback){
...
UserManager.prototype.log = function(user, callback){
	debug(user);
...
UserManager.prototype.searchUser = function(keyword, callback){
